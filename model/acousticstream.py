...
class AcousticStream(nn.Module):
    def __init__(self, standalone: bool = False):
        ...
        self.embedder = Wav2Vec2Model.from_pretrained("facebook/wav2vec2-large-xlsr-53") # -> (batch, seq_len, 1024)
...
class BinaryClassifier(nn.Module):
    def __init__(self, input_size=1024, hidden_size=512): # chose 512 for no particular reason
